...
export const MODEL_PANEL_DEFS: ModelPanelDefinition[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      {label: 'Score weights', text: 'Active replay-search score weights on the latest search run, including drawdown, instability, worst-window loss, peak open-exposure, window-end carry exposure, carry-window frequency, carry-restart continuity, count and deployed-dollar active-window depth, daily/live guard frequency and restart continuity, count-weighted and deployed-dollar coverage, global window inactivity, worst-window coverage, scorer coverage, scorer-window depth, scorer active-window mix, scorer-loss, scorer-inactivity, and concentration terms.'},
      {label: 'Best score', text: 'Best feasible score decomposition: replay P&L minus drawdown, instability, worst-window loss, peak open-exposure, window-end carry exposure, carry-window frequency, carry-restart continuity, active-window depth, daily/live guard frequency and restart continuity, count-weighted and deployed-dollar coverage, global window inactivity, worst-window coverage, scorer coverage, scorer-window depth, scorer-loss, scorer-inactivity, and concentration penalties.'},
      {label: 'Search robust', text: 'Best feasible search candidate P&L and drawdown.'},
      {label: 'Search windows', text: 'Positive versus negative windows, active versus idle participation, carry-window frequency, carry-restart continuity risk, sparsest active-window trade depth and deployed dollars, peak and average window-end carry exposure, and the worst window P&L for the latest best feasible search candidate.'},
      ...
      {label: 'Pause guard', text: 'Replay-search dependence on daily-loss/live-drawdown rejects, active windows that still end with daily/live guard state tripped, and later active windows that restart immediately after those guard-tripped windows.'},
      ...
      {label: 'Cur score', text: 'Current/base score decomposition: replay P&L minus drawdown, instability, worst-window loss, peak open-exposure, window-end carry exposure, carry-window frequency, carry-restart continuity, daily/live guard frequency and restart continuity, count-weighted and deployed-dollar coverage, global window inactivity, worst-window coverage, scorer coverage, scorer-loss, scorer-inactivity, and concentration penalties.'},
      {label: 'Score drift', text: 'Best feasible minus current/base score decomposition, split into replay P&L and each score penalty term, including carry-window frequency, carry-restart continuity, daily/live guard frequency and restart continuity, count-weighted and deployed-dollar coverage, worst-window coverage, inactivity, scorer-path, and concentration penalties.'},
