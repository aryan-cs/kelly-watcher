...
def _segment_shadow_state_payload(report: dict[str, Any]) -> dict[str, object]:
    ...
    return {
        **_shadow_evidence_epoch_state_payload(report),
        ...
        "shadow_wallet_family_classified_signals": max(int(report.get("wallet_family_classified_signals") or 0), 0),
        "shadow_wallet_family_classified_acted": max(int(report.get("wallet_family_classified_acted") or 0), 0),
        "shadow_wallet_family_classified_resolved": max(int(report.get("wallet_family_classified_resolved") or 0), 0),
        "shadow_wallet_family_unassigned_signals": max(int(report.get("wallet_family_unassigned_signals") or 0), 0),
        "shadow_wallet_family_unassigned_acted": max(int(report.get("wallet_family_unassigned_acted") or 0), 0),
...
def _segment_shadow_error_payload(message: str) -> dict[str, object]:
    return {
        **_shadow_evidence_epoch_state_payload(),
        ...
        "shadow_wallet_family_classified_signals": 0,
        "shadow_wallet_family_classified_acted": 0,
        "shadow_wallet_family_classified_resolved": 0,
        "shadow_wallet_family_unassigned_signals": 0,
        "shadow_wallet_family_unassigned_acted": 0,
