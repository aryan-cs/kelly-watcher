...
export function Wallets({ botState, activePane, bestSelectedIndex, worstSelectedIndex, trackedSelectedIndex, droppedSelectedIndex, detailOpen, detailHistoryOffset, onWalletMetaChange, onDetailHistoryMetaChange }) {
    ...
    const walletQueryBlockedMessage = shadowRestartPending
        ...
        : startupRecoveryOnly
            ...
            : dbIntegrityKnown && !dbIntegrityOk
                ...
                : '';
    const walletQueryBlockedLines = walletQueryBlockedMessage
    ...
    }, [activityRows, cursorByWallet, sourceWallets, tierByWallet, traderCacheRows, usernames, walletQueryBlockedLines.length, watchStateByWallet]);
    ...
    const renderWalletQueryBlockedNotice = (width, keyPrefix) => walletQueryBlockedLines.map((line, index) => (React.createElement(Text, { key: `${keyPrefix}-${index}`, color: theme.yellow }, fit(line, width))));
    ...
    const renderShadowWalletBox = (title, pane, shadowWallets) => {
        ...
        return (React.createElement(InkBox, { width: shadowPanelsWide ? undefined : '100%', flexGrow: shadowPanelsWide ? 1 : 0, flexBasis: shadowPanelsWide ? 0 : undefined },
            React.createElement(Box, { title: title, width: "100%", height: shadowPanelHeight, accent: boxIsSelected },
                ...
                })) : (walletQueryBlockedLines.length ? (React.createElement(InkBox, { flexDirection: "column" }, renderWalletQueryBlockedNotice(shadowPanelContentWidth, `${title}-blocked`))) : (React.createElement(Text, { color: theme.dim }, "No wallet performance yet."))))))));
    };
    const renderPageBody = () => (React.createElement(React.Fragment, null,
        walletQueryBlockedLines.length ? (React.createElement(InkBox, { width: "100%", marginBottom: 1, flexDirection: "column", flexShrink: 0 }, renderWalletQueryBlockedNotice(tableWidth, 'wallet-query-blocked'))) : null,
        ...
        React.createElement(InkBox, { marginTop: 1, flexGrow: 1, flexDirection: "column" },
            React.createElement(InkBox, { flexGrow: 1 },
                React.createElement(Box, { height: "100%", accent: activePane === 'tracked' },
                    ...
                    })) : (walletQueryBlockedLines.length ? (React.createElement(InkBox, { flexDirection: "column" }, renderWalletQueryBlockedNotice(tableWidth, 'tracked-wallets-blocked'))) : (React.createElement(Text, { color: theme.dim }, "No watched wallets configured yet.")))),
                    React.createElement(InkBox, { width: "100%", height: 1, flexShrink: 0 },
            ...
            React.createElement(InkBox, { flexGrow: 1 },
                React.createElement(Box, { height: "100%", accent: activePane === 'dropped' },
                    ...
                    })) : (walletQueryBlockedLines.length ? (React.createElement(InkBox, { flexDirection: "column" }, renderWalletQueryBlockedNotice(tableWidth, 'dropped-wallets-blocked'))) : (React.createElement(Text, { color: theme.dim }, "No dropped wallets.")))),
                    React.createElement(InkBox, { width: "100%", height: 1, flexShrink: 0 },
