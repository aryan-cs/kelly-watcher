...
class RuntimeLayout:
    ...
    trade_log_archive_request_file: Path
...
def runtime_layout(repo_root: Path | None = None) -> RuntimeLayout:
    ...
    return RuntimeLayout(
        ...
        trade_log_archive_request_file=data_dir / "trade_log_archive_request.json",
...
TRADE_LOG_ARCHIVE_REQUEST_FILE = _LAYOUT.trade_log_archive_request_file
